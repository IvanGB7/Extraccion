--AQUI PODEMOS VER QUE PRODUCTO TUVO MEJORES VENTAS EN TODO EL ANIO
select * from
(
    ...
    where rank =1 
 ;
-- AQUI SE DETERMINA EL TOP 3 DE PRODUCTOS EN VENTAS
select * from
(
    ...
    where rank <=3 
 ;
-- AQUI SE DETERMINA EL TOP 3 DE TIENDAS
select * from
(
    ...
    where rank <=3 
 ; 
--AQUI SE EVALUA CUANTAS TRANSACCIONES OCURRIERON
...
(
 ...
 ;
--AQUI SE PRESENTA UN REPORTE DE VENTAS  
...
--SE CREA UNA VISTA CON LAS VENTAS DE LA TIENDA SELECCIONADA                
